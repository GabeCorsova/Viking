...
brandingBanner="https://viking.jamfcloud.com/api/v1/branding-images/download/7" # Image by pikisuperstar on Freepik
brandingBannerDisplayText="true"
brandingIconLight="https://viking.jamfcloud.com/api/v1/branding-images/download/6"
brandingIconDark="https://viking.jamfcloud.com/api/v1/branding-images/download/6"
...
supportTeamPhone="+1 (855)-330-3976"
supportTeamEmail="help@corserva.com"
        ...
        * ) # Catch-all )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Starting Enrollment Process",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_4723e3e341a7e11e6881e418cf91b157fcc081bdb8948697750e5da3562df728",
                        "progresstext": "Starting up Enrollment",
                        "trigger_list": [
                                         {
                                            "trigger": "begunEnrollment",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        "listitem": "Installomator App",
                        "icon": "https://d8p1x3h4xd5gq.cloudfront.net/59822132ca753d719145cc4c/public/612df4221178bc73425c3851.jpg",
                        "progresstext": "Checking for Installomator",
                        "trigger_list": [
                                         {
                                            "trigger": "Installomator",
                                            "validation": "/usr/local/Installomator/Installomator.sh"
                                         }
                        ]
                    },
                    {
                        "listitem": "Install Rosetta2",
                        "icon": "https://ics.services.jamfcloud.com/icon/hash_8bac19160fabb0c8e7bac97b37b51d2ac8f38b7100b6357642d9505645d37b52",
                        "progresstext": "Processing policy: Installing Rosetta2 for Apple Silicon",
                        "trigger_list": [
                                         {
                                            "trigger": "Rosetta2Installation",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "trigger_list": [
                                         ...
                                         {
                                            "trigger": "RenameDevice",
                                            "validation": "None"
                                         },
                                         {
                                            "trigger": "NessusAgentApplication",
                                            "validation": "None"
                                         },
                                         {
                                            "trigger": "CortexXDRApplication",
                                            "validation": "None"
                                         },
                                         {
                    ...
                    {
                        "listitem": "GlobalProtect",
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_6bd194bccca72138d6d328cde2b09e052e1025b190a87b6707537c298be4545a",
                        "progresstext": "Processing policy: Installing GlobalProtect",
                        "trigger_list": [
                                         {
                                            "trigger": "GlobalProtectApplication",
                                            "validation": "None"
                                         }
                        ]
                    },
                    ...
                    },
                    {
                        ...
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_ddaf0a68208164124968f2682598638511f5f277a5924b05be24fc87e2e36fb3",
                        "progresstext": "Processing policy: Installing Microsoft Teams",
                        "trigger_list": [
                                         {
                    ...
                    },
                    {
                        ...
                        "icon": "https://usw2.ics.services.jamfcloud.com/icon/hash_3c707f7fe55f6e2574b5ff0d13445b5d430decd4e1301c07de370c803065dc27",
                        "progresstext": "Processing policy: Installing Microsoft Edge",
                        "trigger_list": [
                                         {
                    ...
                    {
                        "listitem": "Wrapping Up",
                        "icon": "",
                        "progresstext": "Almost Done! Wrapping things up!",
                        "trigger_list": [
                                         {
                                            "trigger": "completeEnrollment",
                                            "validation": "None"
                                         }
                        ]
                    }
...
case ${completionActionOption} in
    ...
    "Sleep"* )
        button1textCompletionActionOption="Done"
